    ...
    <section id="terms" className="terms-container p-5">
      <Container>
        ...
        <div className="terms-item">
          <p class="terms-item-title">100 km od Łukowa w cenie!</p>
        ...
        <div className="terms-item">
          <p class="terms-item-title">Profesjonalizm za kierownicą</p>
          <p>
        ...
        <div className="terms-item">
          <p class="terms-item-title">Elastyczny zasięg</p>
